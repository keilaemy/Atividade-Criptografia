...
Já o Cliente.py é utilizado para comunicar-se com o servidor como uma sala de bate-papo. Para verificar a funcionalidade do sistema sugere-se que você abra um terminal para cada instância (primeiro servidor e depois cliente) 
